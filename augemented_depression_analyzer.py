...
from tensorflow.keras.layers import Input, GlobalAveragePooling2D, Activation, AveragePooling2D, BatchNormalization
model = Sequential([
...
# #Save the architecture of the model using the following code:
...
# # tf.keras.models.save_model(export_dir)
# # kerasfile='saved_model.h5'
# # tf.keras.models.save_model(model,kerasfile)

# # tf.saved_model.save(model,os.path.join(cwd_dir, 'saved_model') )
